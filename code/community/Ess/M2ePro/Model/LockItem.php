...
class Ess_M2ePro_Model_LockItem extends Mage_Core_Model_Abstract
{
    ...
    public function create()
    {
        ...
        $data = array();
        $data['update_date'] = Mage::helper('M2ePro')->getCurrentGmtDate();
    ...
    public function remove()
    {
        ...
        Mage::getModel('M2ePro/LockItem')->load($this->nick,'nick')->delete();
        return true;
    }
    ...
    {
        $functionCode = 'Mage::getModel(\'M2ePro/LockItem\')->load(\''.$this->nick.'\',\'nick\')->delete();';
