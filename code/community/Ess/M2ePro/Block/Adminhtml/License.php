...
class Ess_M2ePro_Block_Adminhtml_License extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        if (Mage::getModel('M2ePro/Wizard')->isActive() &&
            Mage::getModel('M2ePro/Wizard')->getStatus() == Ess_M2ePro_Model_Wizard::STATUS_LICENSE) {
            ...
            $this->_addButton('close', array(
                ...
                'onclick'   => 'LicenseHandlersObj.completeStep();',
                'class'     => 'close'
            ));
            ...
            $this->_addButton('reset', array(
                'label'     => Mage::helper('M2ePro')->__('Refresh'),
                'onclick'   => 'LicenseHandlersObj.reset_click()',
                'class'     => 'reset'
            ));
