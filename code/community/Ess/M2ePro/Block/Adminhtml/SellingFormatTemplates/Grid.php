...
class Ess_M2ePro_Block_Adminhtml_SellingFormatTemplates_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('sellingFormatTemplatesGrid');
        //------------------------------
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('M2ePro/SellingFormatTemplates')->getCollection();
    ...
    {
        return $this->getUrl('*/*/gridSellingFormat', array('_current'=>true));
    }
