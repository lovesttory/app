...
class Ess_M2ePro_Block_Adminhtml_Listings_Items extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('listingsItems');
        $this->_blockGroup = 'M2ePro';
        $this->_controller = 'adminhtml_listings_items';
        //------------------------------
        ...
        if (!is_null($this->getRequest()->getParam('back'))) {
            ...
            $this->_addButton('back', array(
                ...
                'onclick'   => 'CommonHandlersObj.back_click(\''.Mage::helper('M2ePro')->getBackUrl('*/adminhtml_listings/items').'\')',
                'class'     => 'back'
            ));
        }
        ...
        $this->_addButton('goto_listings', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_listings/index',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listings/items'))).'\')',
            'class'     => 'button_link'
        ));
        ...
        $this->_addButton('view_log', array(
            ...
            'onclick'   => 'setLocation(\''.$this->getUrl('*/adminhtml_logs/listings',array('back'=>Mage::helper('M2ePro')->makeBackUrlParam('*/adminhtml_listings/items'))).'\')',
            'class'     => 'button_link'
        ));
