...
class Ess_M2ePro_Block_Adminhtml_Listings_AddStepThree extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        //------------------------------
        $this->setId('listingsAddStepThree');
        ...
        // Set header text
        //------------------------------
        $this->_headerText = Mage::helper('M2ePro')->__('Add Listing [Select Categories Products]');
        //------------------------------
        ...
        $this->_addButton('back', array(
            ...
            'onclick'   => 'ProductsGridHandlersObj.back_click(\'' .$this->getUrl('*/*/add',array('step'=>'2')).'\')',
            'class'     => 'back'
        ));
