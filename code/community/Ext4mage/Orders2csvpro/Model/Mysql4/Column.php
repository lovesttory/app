...
* */
class Ext4mage_Orders2csvpro_Model_Mysql4_Column extends Mage_Core_Model_Mysql4_Abstract
{
	public function _construct()
	{
		// Note that the orders2csvpro_id refers to the key field in your database table.
		$this->_init('orders2csvpro/column', 'column_id');
	}
	...
	public function getColumnByFile ($fileId){
