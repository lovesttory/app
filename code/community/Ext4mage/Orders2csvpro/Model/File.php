...
* */
class Ext4mage_Orders2csvpro_Model_File extends Mage_Core_Model_Abstract
{
	...
	*/
	public function getFilesForGrid()
	{
		...
		foreach ($allElements as $element) {
			$options[$element['file_id']] =  $element['title'];
		}
		return $options;
	}
	 ...
	 *
	 * @return Ext4mage_Orders2csvpro_Model_Column
	 */
	 ...
	 *
	 * @return Ext4mage_Orders2csvpro_Model_Mysql4_Column_Collection
	 */
	 ...
	 *
	 * @param Ext4mage_Orders2csvpro_Model_Column $column
	 * @return Ext4mage_Orders2csvpro_Model_File
	 */
	public function addColumn(Ext4mage_Orders2csvpro_Model_Column $column)
	{
	 ...
	 *
	 * @param int $columnId
	 * @return Ext4mage_Orders2csvpro_Model_Column | null
	 */
