 ...
 * @author     Genevieve Eddison, Jonathan Feist, Farai Kanyepi <sales@ext4mage.com>
 * */
class Ext4mage_Orders2csvpro_Admin_Orders2csvproController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function makecsvAction()
    {
		...
		$file = Mage::getModel('orders2csvpro/orders2csvpro')->saveOrdersAsCsv($orders);
