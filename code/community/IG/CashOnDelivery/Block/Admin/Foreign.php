...
class IG_CashOnDelivery_Block_Admin_Foreign extends Mage_Adminhtml_Block_Widget_Grid_Container
{
 	public function __construct()
    {
 		$this->_blockGroup = 'ig_cashondelivery';
		$this->_controller = 'admin_foreign';
		$this->_headerText = Mage::helper('ig_cashondelivery')->__('IG Cash on delivery prices - Foreign fee');
