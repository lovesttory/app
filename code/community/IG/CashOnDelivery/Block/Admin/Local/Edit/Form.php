...
class IG_CashOnDelivery_Block_Admin_Local_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$fieldset = $form->addFieldset('ig_cashondelivery_local', array('legend' => Mage::helper('ig_cashondelivery')->__('Cash on delivery fee')));
