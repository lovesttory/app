...
class Mage_CatalogInventory_Model_Stock_Item extends Mage_Core_Model_Abstract
{
     ...
     * @return  bool
     */
    public function checkQty($qty, $currentItem = false)
    {
        //2010.09.27 HiepHM: Change to check qty even in admin
        //if (!$this->getManageStock() || Mage::app()->getStore()->isAdmin()) {
        if($currentItem && $qty - $currentItem->getQtyOrdered() <= 0) return true;
    ...
    public function checkQuoteItemQty($qty, $summaryQty, $origQty = 0)
    {
        ...
        if($_session->getOrder()->getId()) {
            ...
            foreach ($old_order->getItemsCollection(
