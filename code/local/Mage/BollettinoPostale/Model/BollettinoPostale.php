...
class Mage_BollettinoPostale_Model_BollettinoPostale extends Mage_Payment_Model_Method_Abstract
{
    ...
    * @var string [a-z0-9_]
    */
    protected $_code = 'bollettinopostale';

    protected $_formBlockType = 'BollettinoPostale/form';
    protected $_infoBlockType = 'BollettinoPostale/info';
