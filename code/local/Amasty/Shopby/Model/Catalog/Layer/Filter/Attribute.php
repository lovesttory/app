        ...
        if ($currentVals) {
            ...
            foreach ($attribute->getSource()->getAllOptions() as $option) {
                ...
                if (false !== $k){
                    ...
                    $text .= '<span class="currentFilterItem">'
						  . $option['label'] 
                          . '&nbsp;'
                          . '<a href="' . $url . '" title="'.Mage::helper('catalog')->__('Remove This Item').'" class="removeItemShopBy">'
                          . Mage::helper('catalog')->__('Remove This Item')
                          . '</a></span>';
                }
            }
