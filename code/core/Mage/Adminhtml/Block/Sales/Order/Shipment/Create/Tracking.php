...
class Mage_Adminhtml_Block_Sales_Order_Shipment_Create_Tracking extends Mage_Adminhtml_Block_Template
{
   ...
   public function getCarriers()
	...
	$carriers['custom'] = Mage::helper('sales')->__('Custom Value');
            // inizio modifica TT
	$carriers['Rif. Mitt. Num.'] = "Rif. Mitt. Num.";
	$carriers['Porto'] = "Porto";
	$carriers['Valore da assicurare'] = "Valore da assicurare";
	$carriers['Note'] = "Note";
	$carriers['Partenza'] = "Partenza";
	$carriers['Tot. colli'] = "Tot. colli";
	// fine modifica TT
