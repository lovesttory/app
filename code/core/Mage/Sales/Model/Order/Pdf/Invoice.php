...
class Mage_Sales_Model_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Abstract
{
    public function getPdf($invoices = array())
    {
        ...
        foreach ($invoices as $invoice) {
			...
			// Aggiunge la data fattura
			$page->drawText(Mage::helper('sales')->__('Invoice Date: ') . Mage::helper('core')->formatDate($invoice->getCreatedAtDate(), 'medium', false), 170, 780, 'UTF-8');
			// fine modifiche TT
...
// Sposta le intestazioni delle colonne
// inizio modifiche TT
  /* Add table head */
            ...
            $page->drawText(Mage::helper('sales')->__('Subtotal'), 517, $this->y, 'UTF-8');
// fine modifiche TT
